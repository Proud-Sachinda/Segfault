...
CREATE TABLE `examiner` (
  ...
  KEY `role_id` (`role_id`),
  KEY `test_id` (`test_id`),
  CONSTRAINT `examiner_ibfk_1` FOREIGN KEY (`lecturer_id`) REFERENCES `lecturer` (`lecturer_id`),
  CONSTRAINT `examiner_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`),
  CONSTRAINT `examiner_ibfk_3` FOREIGN KEY (`test_id`) REFERENCES `test` (`test_id`)
...
-- Dump completed on 2019-03-04  8:35:57
